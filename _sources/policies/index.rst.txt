...
.. _curie_system_use_policies:

Curie's System Use Policies
==============================
...
#. Curie is a secure system. No data transfers shall be allowed to or from an unsecured system.
#. By default, users will receive a private directory with a quota of ``1TB``.
#. Upon receiving access to Curie, users can transfer data via ``SFTP`` (over Port 22) from the University of Louisville Campus network or over the UofL Global Protect VPN.
#. Shared directories for projects can be requested on Curie. Users can open a :ref:`ticket <user_support_tickets>` with Research Computing to get that set up with discussion on the Quota needed for the group.